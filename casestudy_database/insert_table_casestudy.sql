INSERT INTO case_study_furama.vi_tri (ten_vi_tri)
VALUE ('Quản Lý'),
	  ('NHân Viên');

INSERT INTO case_study_furama.trinh_do (ten_trinh_do)
VALUE ('Trung Cấp'),
      ('Cao Đẳng'),  
      ('Đại Học'), 
      ('Sau Đại Học');
      
INSERT INTO case_study_furama.bo_phan (ten_bo_phan)
...
INSERT INTO case_study_furama.dich_vu (ten_dich_vu, dien_tich, chi_phi_thue, so_nguoi_toi_da, tieu_chuan_phong, mo_ta_tien_nghi_khac, dien_tich_ho_boi, so_tang, dich_vu_mien_phi_di_kem, ma_kieu_thue, ma_loai_dich_vu)
VALUE
...
INSERT INTO case_study_furama.hop_dong_chi_tiet (so_luong, ma_hop_dong, ma_dich_vu_di_kem) 
VALUE
(5, 2, 4),
(8, 2, 5),
(15, 2, 6),
